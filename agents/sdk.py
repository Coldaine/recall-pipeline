...
from agents.agent import AgentWrapper
...
class Agents:
    ...
    def clear(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "instructions": [
                ...
                "2. Remove the database file: ~/.recall_agents/sqlite.db",
                "3. Restart the Mirix application",
                "4. Initialize a new Mirix agent",
            ],
            "manual_command": "rm ~/.recall_agents/sqlite.db",
    ...
    def _reload_model_settings(self):
        ...
        import agents.settings

        for field_name in ModelSettings.model_fields:
            setattr(
                agents.settings.model_settings,
                field_name,
    ...
    def insert_tool(
        ...
        from agents.schemas.tool import Tool as PydanticTool
        ...
        if existing_tool:
            ...
            from agents.functions.functions import derive_openai_json_schema
        ...
        if apply_to_agents:
            ...
            for agent in all_agents:
                ...
                if created_tool.id not in existing_tool_ids:
                    ...
                    from agents.schemas.agent import UpdateAgent
