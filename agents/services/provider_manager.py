...
from agents.orm.provider import Provider as ProviderModel
from agents.schemas.providers import Provider as PydanticProvider
from agents.schemas.providers import ProviderUpdate
...
class ProviderManager:
    ...
    def get_openai_override_provider_id(self) -> Optional[str]:
        ...
        openai_provider = [
            provider for provider in self.list_providers() if provider.name == "openai"
        ]
