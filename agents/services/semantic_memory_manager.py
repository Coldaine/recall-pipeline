...
from agents.constants import BUILD_EMBEDDINGS_FOR_MEMORY
...
from agents.schemas.semantic_memory import (
    SemanticMemoryItem as PydanticSemanticMemoryItem,
)
from agents.schemas.semantic_memory import SemanticMemoryItemUpdate
from agents.schemas.user import User as PydanticUser
from agents.services.utils import build_query, update_timezone
from agents.settings import settings
from agents.utils import enforce_types, generate_unique_short_id
...
class SemanticMemoryManager:
    ...
    def _parse_embedding_field(self, embedding_value):
        ...
        try:
            ...
            try:
                from agents.helpers.converters import deserialize_vector
