...
from agents.schemas.procedural_memory import (
    ProceduralMemoryItem as PydanticProceduralMemoryItem,
)
from agents.schemas.procedural_memory import ProceduralMemoryItemUpdate
...
class ProceduralMemoryManager:
    ...
    def create_item(
        ...
        if not item_data.id:
            from agents.utils import generate_unique_short_id
