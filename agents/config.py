...
class AgentsConfig:
    ...
    metadata_storage_path: str = AGENTS_DIR
    ...
    agents_version: str = agents.__version__
    ...
    def load(
        ...
        # from agents.migrate import VERSION_CUTOFF, config_is_compatible
        # if not config_is_compatible(allow_empty=True):
        #    error_message = " ".join(
        #        [
        #            f"\nYour current config file is incompatible with Agents versions later than {VERSION_CUTOFF}.",
        #            f"\nTo use Agents, you must either downgrade your Agents version (<= {VERSION_CUTOFF}) or regenerate your config using `agents configure`, or `agents migrate` if you would like to migrate old agents.",
        #        ]
        #    )
        ...
        if os.getenv("MEMGPT_CONFIG_PATH"):
            ...
            config_path = AgentsConfig.config_path
        ...
        if os.path.exists(config_path):
            ...
            config_dict = {
                ...
                "agents_version": get_field(config, "version", "agents_version"),
            }
    ...
    def save(self):
        ...
        # set version
        set_field(config, "version", "agents_version", agents.__version__)
    ...
    def create_config_dir():
        ...
        tmp_folder = os.path.join(AGENTS_DIR, "tmp")
