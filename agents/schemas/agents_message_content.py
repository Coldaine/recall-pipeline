...
AgentsUserMessageContentUnion = Annotated[
    Union[TextContent, ImageContent, FileContent, CloudFileContent],
    Field(discriminator="type"),
]


def create_agents_user_message_content_union_schema():
    return {
        "oneOf": [
...
def get_agents_user_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/AgentsUserMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
AgentsAssistantMessageContentUnion = Annotated[
    Union[TextContent],
    Field(discriminator="type"),
]


def create_agents_assistant_message_content_union_schema():
    return {
        "oneOf": [
            {"$ref": "#/components/schemas/TextContent"},
        ],
...
def get_agents_assistant_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
                "items": {
                    "$ref": "#/components/schemas/AgentsAssistantMessageContentUnion",
                },
            },
            {"type": "string"},
        ],
...
AgentsMessageContentUnion = Annotated[
    Union[
        TextContent,
        ImageContent,
        FileContent,
...
def get_agents_message_content_union_str_json_schema():
    return {
        "anyOf": [
            {
                "type": "array",
