...
from agents.schemas.agents_message_content import (
    AgentsAssistantMessageContentUnion,
    AgentsUserMessageContentUnion,
    get_agents_assistant_message_content_union_str_json_schema,
    get_agents_user_message_content_union_str_json_schema,
)

# ---------------------------
# Agents API Messaging Schemas
# ---------------------------
...
class AgentsMessage(BaseModel):
    """
    Base class for simplified Agents message response type. This is intended to be used for developers
...
class SystemMessage(AgentsMessage):
    """
...
class UserMessage(AgentsMessage):
    """
    ...
    Args:
        ...
        date (datetime): The date the message was created in ISO format
        name (Optional[str]): The name of the sender of the message
        content (Union[str, List[AgentsUserMessageContentUnion]]): The message content sent by the user (can be a string or an array of multi-modal content parts)
    """

    message_type: Literal[MessageType.user_message] = Field(
        MessageType.user_message, description="The type of the message."
    )
    content: Union[str, List[AgentsUserMessageContentUnion]] = Field(
        ...,
        description="The message content sent by the user (can be a string or an array of multi-modal content parts)",
        json_schema_extra=get_agents_user_message_content_union_str_json_schema(),
    )


class ReasoningMessage(AgentsMessage):
    """
...
class HiddenReasoningMessage(AgentsMessage):
    """
...
class ToolCallMessage(AgentsMessage):
    """
...
class ToolReturnMessage(AgentsMessage):
    """
    A message representing the return value of a tool call (generated by Agents executing the requested tool).
...
class AssistantMessage(AgentsMessage):
    """
    ...
    Args:
        ...
        date (datetime): The date the message was created in ISO format
        name (Optional[str]): The name of the sender of the message
        content (Union[str, List[AgentsAssistantMessageContentUnion]]): The message content sent by the agent (can be a string or an array of content parts)
    """
...
def create_agents_message_union_schema():
    return {
        "oneOf": [
...
AgentsMessageUpdateUnion = Annotated[
    Union[
        UpdateSystemMessage,
        UpdateUserMessage,
...
class LegacyFunctionCallMessage(AgentsMessage):
    function_call: str


class LegacyFunctionReturn(AgentsMessage):
    """
    A message representing the return value of a function call (generated by Agents executing the requested function).
...
class LegacyInternalMonologue(AgentsMessage):
    """
