...
from agents.helpers.datetime_helpers import get_utc_time, is_utc_datetime
from agents.helpers.json_helpers import json_dumps
from agents.schemas.enums import MessageRole
from agents.schemas.agents_base import OrmMetadataBase
from agents.schemas.agents_message import (
    AssistantMessage,
...
from agents.schemas.agents_message_content import (
    ...
    FileContent,
    ImageContent,
    AgentsMessageContentUnion,
    ReasoningContent,
    RedactedReasoningContent,
    TextContent,
    get_agents_message_content_union_str_json_schema,
)
from agents.schemas.openai.openai import Function as OpenAIFunction
from agents.schemas.openai.openai import ToolCall as OpenAIToolCall
from agents.system import unpack_message
...
class MessageCreate(BaseModel):
    ...
    content: Union[str, List[AgentsMessageContentUnion]] = Field(
        ...,
        description="The content of the message.",
        json_schema_extra=get_agents_message_content_union_str_json_schema(),
    )
...
class MessageUpdate(BaseModel):
    ...
    content: Optional[Union[str, List[AgentsMessageContentUnion]]] = Field(
        None,
        description="The content of the message.",
        json_schema_extra=get_agents_message_content_union_str_json_schema(),
    )
...
class Message(BaseMessage):
    ...
    content: Optional[List[AgentsMessageContentUnion]] = Field(
    ...
    @staticmethod
    def to_agents_messages_from_list(
        ...
        # Convert messages to AgentsMessages
        return [
            msg
            for m in messages
            for msg in m.to_agents_message(
