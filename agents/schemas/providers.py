...
from agents.constants import LLM_MAX_TOKENS, MIN_CONTEXT_WINDOW
from agents.llm_api.azure_openai import (
    get_azure_chat_completions_endpoint,
    get_azure_embeddings_endpoint,
)
from agents.llm_api.azure_openai_constants import AZURE_MODEL_TO_CONTEXT_LENGTH
from agents.schemas.embedding_config import EmbeddingConfig
from agents.schemas.llm_config import LLMConfig
from agents.schemas.agents_base import AgentsBase


class ProviderBase(AgentsBase):
...
class OpenAIProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from agents.llm_api.openai import openai_get_model_list
...
class AnthropicProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from agents.llm_api.anthropic import anthropic_get_model_list
...
class MistralProvider(Provider):
    ...
    def list_llm_models(self) -> List[LLMConfig]:
        from agents.llm_api.mistral import mistral_get_model_list
...
class GoogleAIProvider(Provider):
    ...
    def list_llm_models(self):
        from agents.llm_api.google_ai import google_ai_get_model_list
    ...
    def get_model_context_window(self, model_name: str) -> Optional[int]:
        from agents.llm_api.google_ai import google_ai_get_model_context_window
...
class AzureProvider(Provider):
    ...
    def list_embedding_models(self) -> List[EmbeddingConfig]:
        from agents.llm_api.azure_openai import azure_openai_get_embeddings_model_list
...
class AnthropicBedrockProvider(Provider):
    ...
    def list_llm_models(self):
        from agents.llm_api.aws_bedrock import bedrock_get_model_list
    ...
    def get_model_context_window(self, model_name: str) -> Optional[int]:
        ...
        from agents.llm_api.aws_bedrock import bedrock_get_model_context_window
