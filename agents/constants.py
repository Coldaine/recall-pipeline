...
AGENTS_DIR = os.path.join(os.path.expanduser("~"), ".recall_agents")
AGENTS_DIR_TOOL_SANDBOX = os.path.join(AGENTS_DIR, "tool_sandbox_dir")
...
AGENTS_CORE_TOOL_MODULE_NAME = "agents.functions.function_sets.base"
AGENTS_MEMORY_TOOL_MODULE_NAME = "agents.functions.function_sets.memory_tools"
AGENTS_EXTRA_TOOL_MODULE_NAME = "agents.functions.function_sets.extras"
