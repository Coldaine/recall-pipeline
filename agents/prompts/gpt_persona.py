...
from agents.constants import AGENTS_DIR
...
def get_persona_text(key):
    ...
    if os.path.exists(file_path):
        ...
        # try looking in ~/.recall_agents/personas/*.txt (but don't create the directory)
        user_system_prompts_dir = os.path.join(AGENTS_DIR, "personas")
