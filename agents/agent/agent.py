...
from agents.constants import (
    ...
    AGENTS_CORE_TOOL_MODULE_NAME,
    AGENTS_EXTRA_TOOL_MODULE_NAME,
    AGENTS_MEMORY_TOOL_MODULE_NAME,
    REQ_HEARTBEAT_MESSAGE,
)
from agents.embeddings import embedding_model
from agents.errors import ContextWindowExceededError, LLMError
from agents.functions.functions import get_function_from_module
from agents.helpers import ToolRulesSolver
from agents.helpers.message_helpers import prepare_input_message_create
from agents.interface import AgentInterface
from agents.llm_api.helpers import (
    calculate_summarizer_cutoff,
    get_token_counts_for_messages,
    is_context_overflow_error,
)
from agents.llm_api.llm_api_tools import create
from agents.llm_api.llm_client import LLMClient
from agents.memory import summarize_messages
from agents.orm import User
from agents.orm.enums import ToolType
from agents.schemas.agent import AgentState, AgentStepResponse, UpdateAgent
from agents.schemas.block import BlockUpdate
from agents.schemas.embedding_config import EmbeddingConfig
from agents.schemas.enums import MessageRole
from agents.schemas.memory import ContextWindowOverview, Memory
from agents.schemas.message import Message, MessageCreate
from agents.schemas.agents_message_content import (
    CloudFileContent,
    FileContent,
    ImageContent,
    TextContent,
)
from agents.schemas.openai.chat_completion_request import (
    Tool as ChatCompletionRequestTool,
)
from agents.schemas.openai.chat_completion_response import (
...
from agents.schemas.tool_rule import TerminalToolRule
from agents.schemas.usage import AgentsUsageStatistics
from agents.services.agent_manager import AgentManager
from agents.services.block_manager import BlockManager
from agents.services.episodic_memory_manager import EpisodicMemoryManager
from agents.services.file_manager import FileManager
from agents.services.helpers.agent_manager_helper import (
    check_supports_structured_output,
    compile_memory_metadata_block,
)
from agents.services.knowledge_vault_manager import KnowledgeVaultManager
from agents.services.message_manager import MessageManager
from agents.services.procedural_memory_manager import ProceduralMemoryManager
from agents.services.resource_memory_manager import ResourceMemoryManager
from agents.services.semantic_memory_manager import SemanticMemoryManager
from agents.services.step_manager import StepManager
from agents.services.tool_execution_sandbox import ToolExecutionSandbox
from agents.services.user_manager import UserManager
from agents.settings import summarizer_settings
...
from agents.tracing import trace_method
...
class Agent(BaseAgent):
        ...
        try:
            ...
            if target_mirix_tool.tool_type == ToolType.MIRIX_CORE:
                ...
                callable_func = get_function_from_module(
                    AGENTS_CORE_TOOL_MODULE_NAME, function_name
                )
                function_args["self"] = (
                ...
                callable_func = get_function_from_module(
                    AGENTS_MEMORY_TOOL_MODULE_NAME, function_name
                )
                ...
                callable_func = get_function_from_module(
                    AGENTS_EXTRA_TOOL_MODULE_NAME, function_name
                )
                function_args["self"] = (
                    self  # need to attach self to arg since it's dynamically linked
                )
    ...
    def step(
        ...
        **kwargs,
        ...
        return AgentsUsageStatistics(**total_usage.model_dump(), step_count=step_count)
