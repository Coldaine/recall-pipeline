...
from agents.schemas.cloud_file_mapping import (
...
class CloudFileMapping(SqlalchemyBase, OrganizationMixin):
    ...
    cloud_file_id: Mapped[str] = mapped_column(String, doc="ID of the cloud file")
    ...
    organization: Mapped["Organization"] = relationship(
        "Organization", back_populates="cloud_file_mappings", lazy="selectin"
    )
