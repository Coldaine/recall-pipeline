...
class Step(SqlalchemyBase):
    ...
    id: Mapped[str] = mapped_column(
        String, primary_key=True, default=lambda: f"step-{uuid.uuid4()}"
    )
    origin: Mapped[Optional[str]] = mapped_column(
        nullable=True, doc="The surface that this agent step was initiated from."
    )
    ...
    provider_name: Mapped[Optional[str]] = mapped_column(
        None, nullable=True, doc="The name of the provider used for this step."
    )
    model: Mapped[Optional[str]] = mapped_column(
        None, nullable=True, doc="The name of the model used for this step."
    )
    ...
    completion_tokens: Mapped[int] = mapped_column(
        default=0, doc="Number of tokens generated by the agent"
    )
    prompt_tokens: Mapped[int] = mapped_column(
        default=0, doc="Number of tokens in the prompt"
    )
    total_tokens: Mapped[int] = mapped_column(
        default=0, doc="Total number of tokens processed by the agent"
    )
    ...
    tid: Mapped[Optional[str]] = mapped_column(
        None, nullable=True, doc="Transaction ID that processed the step."
    )
    ...
    messages: Mapped[List["Message"]] = relationship(
        "Message", back_populates="step", cascade="save-update", lazy="noload"
    )
