...
class DeploymentMixin(Base):
    """Mixin for deployment identification (single-user, multi-machine)."""

    __abstract__ = True

    deployment_id: Mapped[str] = mapped_column(
        String, nullable=False, doc="Identifies which machine/deployment captured this data"
    )
