...
from agents.constants import MAX_EMBEDDING_DIM
from agents.orm.custom_columns import CommonVector, EmbeddingConfigColumn
...
class ProceduralMemoryItem(SqlalchemyBase, DeploymentMixin):
    """
