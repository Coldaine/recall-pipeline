...
from agents.local_llm.utils import count_tokens
from agents.schemas.message import Message
from agents.schemas.openai.chat_completion_request import ChatCompletionRequest, Tool
...
from agents.utils import get_tool_call_id, get_utc_time, json_dumps, smart_urljoin
    ...
    if "tool_calls" in response_json and response_json["tool_calls"] is not None:
        ...
        for tool_call_response in response_json["tool_calls"]:
            ...
            if inner_thoughts_in_kwargs:
                from agents.local_llm.constants import INNER_THOUGHTS_KWARG
...
def convert_tools_to_cohere_format(
    ...
    if inner_thoughts_in_kwargs:
        ...
        from agents.local_llm.constants import (
