...
from agents.constants import INNER_THOUGHTS_KWARG, INNER_THOUGHTS_KWARG_DESCRIPTION
...
from agents.helpers.datetime_helpers import get_utc_time
from agents.llm_api.helpers import (
    add_inner_thoughts_to_functions,
    unpack_all_inner_thoughts_from_kwargs,
)
from agents.llm_api.llm_client_base import LLMClientBase
...
from agents.schemas.openai.chat_completion_request import Tool
...
from agents.schemas.openai.chat_completion_response import Message as ChoiceMessage
...
class AnthropicClient(LLMClientBase):
    ...
    def fill_image_content_in_messages(self, messages: List[dict]) -> List[dict]:
        ...
        from agents.constants import LOAD_IMAGE_CONTENT_FOR_LAST_MESSAGE_ONLY
